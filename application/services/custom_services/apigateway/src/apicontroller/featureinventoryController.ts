...
export class featureinventoryController implements Controller {
    ...
    private initializeRoutes() {
        this.router.delete('/featureinventory/:id', this.GpDelete);
this.router.get('/featureinventory/get/search', this.GpSearch);
this.router.put('/featureinventory/get/update', this.GpSearchForUpdate);
this.router.put('/featureinventory', this.GpUpdate);
this.router.get('/featureinventory/:id', this.GpGetEntityById);
this.router.get('/featureinventory', this.GpGetAllValues);
this.router.post('/featureinventory', this.GpCreate);
this.router.get('/featureinventory/userid/created_by', this.GpGetNounCreatedBy);
        //#@gepdelimeterone@#
        //#@ssofacebookapiroute@#
        //#@ssogithubapiroute@#
        //#@gepbankingapiroute@#
...
public GpDelete(req: Request, res: Response) {
        ...
        new ApiAdapter().delete(Constant.FEATUREINVENTORYURL + `${req.url}` )
...
public GpSearch(req: Request, res: Response) {
        ...
        new ApiAdapter().get(Constant.FEATUREINVENTORYURL + `${req.url}` )
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
...
public GpSearchForUpdate(req: Request, res: Response) {
        ...
        new ApiAdapter().put(Constant.FEATUREINVENTORYURL + `${req.url}` , req.body)
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
...
public GpCreate(req: Request, res: Response) {
        ...
        new ApiAdapter().post(Constant.FEATUREINVENTORYURL + `${req.url}` , req.body)
        .then((res: any) => res.response.json()).then(result => {
            switch(req.baseUrl) { case '/mobile': res.send(result); break; case '/web': res.send(result); break; default: res.send(null); }
